...
const videoTestimonials: VideoTestimonial[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      "October -> Travelled while working freely to Turkey and met Jamil in UAE",
    ],
  ...
  },
  {
    ...
    timeline: [
      ...
      "June 14 –> Working hard and is happy for his role and position. Looking to receive many commissions soon",
      "July 15 -> Made around $1.7k throughout his journey",
      "Jul 19 -> Made almost $2.1k on his offer where he now works as an executive assistant",
  ...
  },
  {
    ...
    timeline: [
      ...
      "End August -> Hired as a coach for a different offer",
      "September -> Collected his first paycheck from his new offer. ",
      "September 6 -> About to settle in an apartment in Madinah soon in sha allah",
    ],
  ...
  },
  {
    ...
    timeline: [
      ...
      "April 15 -> Working for Javan Zhang as an appointment setter",
      "April 27 -> Uptil this point, helped me appointment set thousands of dollars in Javan Zhang's pipeline",
      "April 28 -> Started working for Pivot2Tech(6 figure tech education) as an appointment setter.",
      "May 3 -> Started working for Coding4Hijrah/Buildfst as an appointment setter ONTOP of Pivot2Tech",
      ...
      "May 31 -> Got hired for his biggest high ticket sales role yet with Thom de Fillet.",
      "Jul 1 -> Promoted to executive assistant at Coding4Hijrah/Buildfst and now gets a base salary",
      "Jul 18 -> Promoted to executive assistant at Coding4Hijrah/Buildfst and now gets a base salary",
    ],
  ...
  },
  {
    ...
    timeline: [
      ...
      "Jul 29 -> Made almost $4k in total",
  ...
  },
  {
    ...
    timeline: [
      ...
      "June 4 –> Generated around under $1000 commission for himself on the role",
      "July -> Made $1000+ and also got promoted on his current role",
      "July 14 -> Landed a role with an agency owner with 76k followers on Instagram and 1.8k members on skool and now gets a 4 figure base salary + commission",
    ],
